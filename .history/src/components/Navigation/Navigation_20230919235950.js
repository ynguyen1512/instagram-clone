...
const Navigation = (props) => {
  ...
  const [toastForSearchShown, setToastForSearchShown] = useState(false);
  const [toastForNotificationShown, setToastForNotificationShown] =
    useState(false);

  const handleSearch = () => {
    if (!toastForSearchShown) {
      toast.error("This feature is not enabled");
      setToastForSearchShown(true);
    }
  };

  const handleNotification = () => {
    if (!toastForNotificationShown) {
      toast.error("This feature is not enabled");
      setToastForNotificationShown(true);
    }
  };
  const handleClose = () => {
    setShow(false);
  ...
  return (
    <div className="sidenav">
      ...
      <div className="sidenav__buttons">
        ...
        <button className="sidenav__button" onClick={handleSearch}>
        ...
        <button onClick={handleMessageClick} className="sidenav__button">
      ...
      {isMoreVisible && <MoreFeatures isMoreVisible={setIsMoreVisible} />}
      <div className="sidenav__more">
        <button onClick={handleMoreClick} className="sidenav__button">
          <MenuOutlinedIcon className="sidenav__icon" />
