...
function ModalCreatePost(props) {
  ...
  const finishPost = () => {
    const newPost = {
      user: "YourUsername", // Replace this with the user's data, if you have it
      postImage: previewImage,
      like: 0, // starting with 0 likes
      timestamp: new Date().toISOString(),
      caption: caption,
    };

    addPost(newPost); // Add the post
        ...
        <Modal.Body style={{ backgroundColor: "#262626" }}>
          <Container>
            ...
            <Button
              variant="primary"
              style={{ backgroundColor: "#0095f6", fontSize: "12px" }}
              onClick={finishPost} // Close the second modal when finishing
            >
              Finish
            </Button>
          </Container>
