...
function WindowChat({ selectedUser, onClose }) {
  ...
  return (
    <div
      className="d-flex flex-column vh-100 wrapper"
      style={{ width: "100%" }}
    >
      ...
      <div className="flex-grow-1 d-flex flex-column p-3">
        ...
        <Form
          className="d-flex justify-content-between align-items-center border rounded-4"
          onSubmit={(e) => {
            e.preventDefault();
            // handleOnSubmit();
          }}
        >
          <Form.Control
            className="border-0 flex-grow-1 rounded-4"
            type="text"
            value={inputValue}
          ...
          <span
            type="submit"
            className="ms-2 fw-bold send-btn"
            style={{ color: "#00559a", marginRight: "10px" }}
          >
            <span>Send</span>
          </span>
        </Form>
